...
func (client *Client) DoFetch(fetchConfig FetchConfig, id string) (*http.Response, error) {
	u := *client.restURL
...
func (client *Client) FetchNumberOfDays(days_to_fetch int, id string) (*http.Response, error) {
...
func (client *Client) FetchPreviousMonths(days_to_fetch int, id string) (*http.Response, error) {
	currentTime := time.Now()
...
func (client *Client) FetchCurrentMonth(id string) (*http.Response, error) {
	currentTime := time.Now()
...
func (client *Client) FetchPreviousWeeks(days_to_fetch int, id string) (*http.Response, error) {
	currentTime := time.Now()
...
func (client *Client) FetchCurrentWeek(id string) (*http.Response, error) {
	currentTime := time.Now()
	// End date is current day
	endDate := currentTime.Format("2006-01-02")
